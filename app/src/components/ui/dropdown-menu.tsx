...
const DropdownMenuCheckboxItem = ({ checked, children, className, ...properties }: React.ComponentProps<typeof DropdownMenuPrimitive.CheckboxItem>) => (
...
const DropdownMenuSubContent = ({ className, ...properties }: React.ComponentProps<typeof DropdownMenuPrimitive.SubContent>) => (
