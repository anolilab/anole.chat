...
const TooltipProvider = ({ delayDuration = 0, ...properties }: React.ComponentProps<typeof TooltipPrimitive.Provider>) => <TooltipPrimitive data-slot="tooltip-provider" delayDuration={delayDuration} {...properties} />;
