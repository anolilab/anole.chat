...
export function EmailOTPButton({ classNames, isSubmitting, localization, view }: EmailOTPButtonProps) {
    ...
    return (
        ...
        >
            ...
            {localization.SIGN_IN_WITH} {view === "EMAIL_OTP" ? localization.PASSWORD : localization.EMAIL_OTP}
        </Button>
    );
}
