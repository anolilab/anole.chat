...
export const ResetPasswordEmail = ({ resetLink, username }: { resetLink: string; username: string }) => (
    <EmailLayout preview="Reset your password">
        ...
        <Text className="mt-6 text-sm text-gray-500">If you didn't request a password reset, you can safely ignore this email.</Text>
    </EmailLayout>
);
