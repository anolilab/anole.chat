    ...
    steps: z
        .array(
            z.object({
                ...
                thought: z.string().describe("Your current thinking step").default("Hmm, let's see... 🤔"),
            }).strict(),
        )
        .describe("Sequence of thinking steps that form your reasoning process. Include all steps from initial analysis to final conclusion.")
        .default([
            {
