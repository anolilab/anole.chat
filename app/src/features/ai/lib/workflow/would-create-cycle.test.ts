...
describe("wouldCreateCycle", () => {
    ...
    it("should return true for indirect cycle (A -> B -> C -> A)", () => {
        ...
        const existingEdges = [createEdge("1", "A", "B"), createEdge("2", "B", "C")];
    ...
    it("should return false for branching without cycles", () => {
        ...
        const existingEdges = [createEdge("1", "A", "B"), createEdge("2", "A", "C"), createEdge("3", "B", "D"), createEdge("4", "C", "D")];
    ...
    it("should return false for disconnected components", () => {
        const connection = createConnection("D", "E");
        const existingEdges = [createEdge("1", "A", "B"), createEdge("2", "B", "C"), createEdge("3", "X", "Y"), createEdge("4", "Y", "Z")];
    ...
    it("should return false when connection source or target is missing", () => {
        ...
        expect(wouldCreateCycle(connectionWithoutSource, existingEdges)).toBe(false);
        expect(wouldCreateCycle(connectionWithoutTarget, existingEdges)).toBe(false);
    });
    ...
    it("should detect long cycle path", () => {
        ...
        const existingEdges = [createEdge("1", "A", "B"), createEdge("2", "B", "C"), createEdge("3", "C", "D"), createEdge("4", "D", "E")];
    ...
    it("should handle multiple incoming edges to same node", () => {
        const connection = createConnection("D", "A");
        const existingEdges = [createEdge("1", "A", "D"), createEdge("2", "B", "D"), createEdge("3", "C", "D")];
