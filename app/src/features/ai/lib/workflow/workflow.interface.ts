...
import type { ObjectJsonSchema7, TipTapMentionJsonContent } from "@/types/util";
 ...
 */
export type WorkflowToolKey = (MCPTool | DefaultTool) & {
    description: string;
    id: string; // tool Name
 ...
 */
export type WorkflowNodeData = InputNodeData | OutputNodeData | LLMNodeData | NoteNodeData | ToolNodeData | ConditionNodeData | HttpNodeData | TemplateNodeData;
 ...
 */
export type UINode<Kind extends NodeKind = NodeKind> = Node<Extract<WorkflowNodeData, { kind: Kind }> & { runtime?: NodeRuntimeField }>;
