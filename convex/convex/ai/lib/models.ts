...
export const MODELS_SHARED: SharedModel[] = [
    ...
    },
    {
        abilities: ["text", "function_calling", "reasoning"],
        adapters: [
            "internal-google:gemini-2.0-flash-lite",
    ...
    },
    {
        ...
        adapters: [
            "internal-google:gemini-2.0-flash-exp",
    ...
    },
    {
        abilities: ["text", "function_calling", "reasoning"],
        adapters: [
            "internal-google:gemini-2.0-flash",
    ...
    },
    {
        abilities: ["image", "reasoning"],
        adapters: [
            "internal-fal:fal-ai/fast-lightning-sdxl",
    ...
    },
    {
        abilities: ["image", "reasoning"],
        adapters: [
            "internal-fal:fal-ai/flux/schnell",
    ...
    },
    {
        ...
        adapters: [
            "internal-groq:llama-3.1-8b-instant",
    ...
    },
    {
        ...
        adapters: [
            "internal-groq:meta-llama/llama-4-scout-17b-16e-instruct",
